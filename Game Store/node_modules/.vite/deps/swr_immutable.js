import {
  require_react
} from "./chunk-DWTQGDXW.js";
import {
  __toESM
} from "./chunk-TWLJ45QX.js";

// node_modules/.pnpm/swr@1.3.0_react@18.2.0/node_modules/swr/dist/index.esm.js
...
// node_modules/.pnpm/swr@1.3.0_react@18.2.0/node_modules/swr/immutable/dist/index.esm.js
...
var isFunction2 = function(v) {
  return typeof v == "function";
};
var normalize2 = function(args) {
  return isFunction2(args[1]) ? [args[0], args[1], args[2] || {}] : [args[0], null, (args[1] === null ? args[2] : args[1]) || {}];
};
var withMiddleware = function(useSWR2, middleware) {
  return function() {
    var args = [];
    for (var _i = 0; _i < arguments.length; _i++) {
      args[_i] = arguments[_i];
    }
    var _a2 = normalize2(args), key = _a2[0], fn = _a2[1], config = _a2[2];
    var uses = (config.use || []).concat(middleware);
    return useSWR2(key, fn, __assign(__assign({}, config), { use: uses }));
  };
};
